...
<div class="row">
					   <div class="col-sm-12 col-md-9 col-lg-9 mx-auto">
						   <?php
						   echo "ชื่อ ".$row['u_name']."&nbsp;&nbsp;&nbsp; ที่อยู่".$row['u_address'];
						   ?>
					   </div>
					   <div class="col-sm-12 col-md-3 col-lg-3 mx-auto">
						
						   <a href="detailu.php?cid=<?php echo $row['u_id']; ?>" class="btn btn-primary">รายละเอียด</a>
					   </div>
</div>
</li>
					   <?php }
